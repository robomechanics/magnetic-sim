...
GOAL_FORCE  = 956.37   # N   — EML63mm-12 – Round Permanent Electromagnet 63 mm Dia. 12 volts DC – Holding 215 lbs
peel_R = 0.057 # m
GOAL_WRENCH = GOAL_FORCE * peel_R     # N·m
...
space: list = [
    ...
    Real(800.0,  1200, "log-uniform", name="max_force_per_wheel"),
]
